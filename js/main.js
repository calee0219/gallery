...
function photoGallery() {
    ...
    function changeEntry() {
        ...
        if (permalinks.length == 1) {
            ...
            //$("pctnav-next").addAddribute("disabled", false);
        } else if (crIndex == 0) {
            wrap.className = c.classL;
            //$("pctnav-prev").addAddribute("disabled", false);
        } else {
            wrap.className = "";
            //$("pctnav-next").addAddribute("disabled", true);
            //$("pctnav-prev").addAddribute("disabled", true);
        }
